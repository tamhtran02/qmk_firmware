...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT_tkl_f13_ansi(
        KC_SLEP,  KC_F13 ,  KC_F14 ,  KC_F15 ,  KC_F16 ,  KC_F17 ,  KC_F18 ,  KC_F19 ,  KC_F20 ,  KC_F21 ,  KC_F22 ,  KC_F23 ,  KC_F24 ,    RGB_TOG,  KC_PSCR,  KC_SCRL,  KC_PAUS,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  KC_WBAK,  KC_WHOM,  KC_WFWD,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  KC_MSEL,  KC_CALC,  KC_MAIL,
        KC_CAPS,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,              _______,
        _______,            _______,  _______,  _______,  _______,  _______,  NK_TOGG,  _______,  _______,  _______,  _______,              _______,            RGB_HUI,
        _______,  _______,  _______,                                _______,                                QK_BOOT,  EE_CLR ,  _______,    _______,  RGB_SAD,  RGB_HUD,  RGB_SAI),
};
...
void keyboard_post_init_user(void) {
  ...
  rgb_matrix_enable();
  rgb_matrix_mode(RGB_MATRIX_CUSTOM_BACKLIGHT);
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    switch (keycode) {
        ...
        // case RGB_HU0:
        //     if (record->event.pressed) {
        //         rgb_matrix_sethsv(0, rgb_matrix_get_sat(), rgb_matrix_get_val());
        //     }
        //     return false;  // Skip all further processing of this key
        // case RGB_SA0:
        //     if (record->event.pressed) {
